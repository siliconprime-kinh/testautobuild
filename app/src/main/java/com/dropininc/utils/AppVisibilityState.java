...
public class AppVisibilityState implements Application.ActivityLifecycleCallbacks {

    public static final String TAG = AppVisibilityState.class.getName();
    ...
    private static AppVisibilityState instance;
    ...
    public static AppVisibilityState init(Application application) {
        if (instance == null) {
            instance = new AppVisibilityState();
            application.registerActivityLifecycleCallbacks(instance);
        }
        return instance;
    }

    public static AppVisibilityState get(Application application) {
        if (instance == null) {
            init(application);
        }
        return instance;
    ...
    public static AppVisibilityState get() {
        if (instance == null) {
            throw new IllegalStateException(
                    "AppVisibilityState is not initialised - first invocation must use parameterised init/get");
        }
        return instance;
    }
