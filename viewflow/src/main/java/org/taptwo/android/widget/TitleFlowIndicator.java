...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
	...
	public TitleFlowIndicator(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TitleViewFlowIndicator);

		String customTypeface = a.getString(R.styleable.TitleViewFlowIndicator_customTypeface);
		// Retrieve the colors to be used for this view and apply them.
		int footerColor = a.getColor(R.styleable.TitleViewFlowIndicator_flow_footerColor, FOOTER_COLOR);
		footerLineHeight = a.getDimension(R.styleable.TitleViewFlowIndicator_flow_footerLineHeight, FOOTER_LINE_HEIGHT);
		footerTriangleHeight = a.getDimension(R.styleable.TitleViewFlowIndicator_flow_footerTriangleHeight, FOOTER_TRIANGLE_HEIGHT);
		int selectedColor = a.getColor(R.styleable.TitleViewFlowIndicator_flow_selectedColor, SELECTED_COLOR);
		boolean selectedBold = a.getBoolean(R.styleable.TitleViewFlowIndicator_flow_selectedBold, SELECTED_BOLD);
		int textColor = a.getColor(R.styleable.TitleViewFlowIndicator_flow_textColor, TEXT_COLOR);
		float textSize = a.getDimension(R.styleable.TitleViewFlowIndicator_textSize, TEXT_SIZE);
		float selectedSize = a.getDimension(R.styleable.TitleViewFlowIndicator_flow_selectedSize, textSize);
		titlePadding = a.getDimension(R.styleable.TitleViewFlowIndicator_flow_titlePadding, TITLE_PADDING);
		clipPadding = a.getDimension(R.styleable.TitleViewFlowIndicator_flow_clipPadding, CLIP_PADDING);
